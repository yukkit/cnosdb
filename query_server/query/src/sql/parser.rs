...
mod tests {
    ...
    fn test_parse_copy_into_table_no_error() {
        let sql = r#"
            ...
            copy into mytable from 's3://bucket/path' files = ('a.csv', 'b.csv') pattern = '2018*.csv' CONNECTION = (xx='a', sss='ss') file_format = (type = 'csv');
            copy into mytable from 's3://bucket/path' files = ('a.csv', 'b.csv') pattern = '2018*.csv' CONNECTION = (xx='a', sss='ss') file_format = (type = 'csv') copy_options = (on_error = 'abort');
        "#;
